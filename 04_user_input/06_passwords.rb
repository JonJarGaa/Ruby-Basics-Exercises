...
where the password is a string that is defined as 
a constant in your program. Keep asking for the 
...
MY ANSWER: 
I did not use all caps to initiate the constant and
my soluton uses a while loop instead of a for loop. 
